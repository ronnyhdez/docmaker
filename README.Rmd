...
`docmaker` is a package that allows you to automate your steps for using GitHub
pages, MkDocs and Rmarkdown.

If you have a project in which there are files built with Rmarkdown that you 
...
will need to implement a structure to be able to use GitHub pages and MkDocs. For
